...
void LCD_vInit(void)
{
 ...
 DIO_vsetPINDir(port_lcd_Control,EN,1);
 DIO_vsetPINDir(port_lcd_Control,RW,1);
 DIO_vsetPINDir(port_lcd_Control,RS,1);
 DIO_write(port_lcd_Control,RW,0);
...
{
 DIO_write(port_lcd_Control,EN,1);
 _delay_ms(2);
 DIO_write(port_lcd_Control,EN,0);
 _delay_ms(2);
}
void LCD_vSend_cmd(char cmd)
{
 ...
 DIO_write(port_lcd_Control,RS,0);
 send_falling_edge();
...
void LCD_vSend_char(char data)
{
 ...
 DIO_write(port_lcd_Control,RS,1);
 send_falling_edge();
